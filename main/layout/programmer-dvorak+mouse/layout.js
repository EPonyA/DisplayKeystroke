loadLayout(
    {
        ...
        items:
            [
                ...
                {
                    image: { x: 100, y: 55 },
                   text: { key_code: '37', text: '[<br>7' }
                },
                {
                    image: { x: 150, y: 55 },
                   text: { key_code: '35', text: '{<br>5' }
                },
                {
                    image: { x: 200, y: 55 },
                   text: { key_code: '33', text: '}<br>3' }
                },
                {
                    image: { x: 250, y: 55 },
                   text: { key_code: '31', text: '(<br>1' }
                },
                {
                    image: { x: 300, y: 55 },
                   text: { key_code: '39', text: '=<br>9' }
                },
                {
                    image: { x: 350, y: 55 },
                   text: { key_code: '30', text: '*<br>0' }
                },
                {
                    image: { x: 400, y: 55 },
                   text: { key_code: '32', text: ')<br>2' }
                },
                {
                    image: { x: 450, y: 55 },
                   text: { key_code: '34', text: '+<br>4' }
                },
                {
                    image: { x: 500, y: 55 },
                   text: { key_code: '36', text: ']<br>6' }
                },
                {
                    image: { x: 550, y: 55 },
                    text: { key_code: '38', text: '!<br>8' }
                },
                {
                    image: { x: 600, y: 55 },
                   text: { key_code: 'df', text: '#<br>`' }
                },
                {
                    image: { x: 650, y: 55 },
